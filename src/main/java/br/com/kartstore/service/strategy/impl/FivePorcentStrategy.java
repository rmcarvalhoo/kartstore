...
@Slf4j
@Component
public class FivePorcentStrategy implements CalcStrategy {
    ...
    public BigDecimal calc(Long amount, BigDecimal productValue) {
        ...
        BigDecimal discount = total.multiply(BigDecimal.valueOf(CalcType.FIVE.getCod().longValue()).divide(BigDecimal.valueOf(100)));
